...
//		Employee.java e1 = new Employee.java(); // defoult contructor olmadigi icin
			                          //Employee.java classda hata veriyor.
...
//		e1.printDetails();
		...
		/*
		 ...
		 Which is the result?
		 A) Compilation fails in the Employee.java class
		 ...
		 E) Both the Employee.java class and the Test class fail to compile
		 
		 cevap: E

		 Employee.java classda ;constructorda This() ilk satırda yer almalı.
